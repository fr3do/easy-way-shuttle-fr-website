...
<title>traitement step 2 bis</title>
<link href="css/tarifs-css/tarifs.css" rel="stylesheet" type="text/css" />
<link href="css/aristo-css/style-resa.css" rel="stylesheet" type="text/css" />
...
<div class="title">
        <h1><span class="blue">Votre</span><span class="logo2">Réservation</span></h1>
        <p class="claim3">Deuxième étape * (champs obligatoires)</p>
		<p class="claim"><span class="blue">Merci de renseigner votre Nom et Prénom en lettres Majuscules</span></p>
</div>
...
?>
   ...
   <div class="divelem">Votre Nom <span class="blue">*</span></div>
   <div class="divelem2"><input name="last_name" class="picker" type="text" /></div>
   <div class="divelem">Votre Prénom <span class="blue">*</span></div>
   ...
   <div class="divelem">Telephone <span class="blue">*</span></div>
   <div class="divelem2"><input name="tel" class="picker" type="text"></div>
   <div class="divelem">E-mail <span class="blue">*</span></div>
   ...
   <div class="divelem2"><input name="nfl" class="picker" type="text"></div>
   <div class="divelem">Provenance ou Destination</div>
       <div class="divelem2"><select name="oai" id="oai" class="SelectBox">
   ...
   <div class="space"></div>
   <div class="divelem"><label for="">Date et Heure du rendez-vous <span class="blue">*</span></label></div>
   ...
   <div class="divelem">Address <span class="blue">*</span></div>
   <p><textarea name="adr_hot" rows=4 cols=30 style="margin-top:10px"></textarea></p>
   <div class="clear"></div>
   <div id="js_errors"></div>
   <div class="divpreced"><a id="linkButton" href="javascript:history.go(-1)">Retour</a></div>
   <div class="divsubmit">
