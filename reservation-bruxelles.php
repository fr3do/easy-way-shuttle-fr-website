...
<meta name="description" content="reservez d'une manière simple et pas cher pour vos déplacements vers Bruxelles" />
<meta http-equiv="Content-Language" content="fr" />
<title>easy-way-shuttle | Navette privé à prix Low Cost de Paris vers Bruxelles</title>
...
<script type="text/javascript">
 ...
 function aff_prix_b(aa) {
	   if(aa=='0')
	{
	 ...
	 if((aa=='1') || (aa=='2') || (aa=='3'))
	{
		//document.getElementById("aff").innerHTML=' 350€';
		document.form1.amount.value='350';
	}
	...
	if((aa=='15') || (aa=='16'))
	{
		//document.getElementById("aff").innerHTML=' 850 €';
		document.form1.amount.value='850';
	}
...
<span class="grey">Bruxelles (Belgium)</span><br>
