...
<meta name="description" content="reservez d'une manière simple et pas cher pour vos déplacements vers Versailles" />
<meta http-equiv="Content-Language" content="fr" />
<title>easy-way-shuttle | Navette privé à prix Low Cost de Paris vers Versailles</title>
...
<script type="text/javascript">
 ...
 function aff_prix_b(aa) {
	   if(aa=='0')
	{
	 ...
	 if((aa=='1') || (aa=='2') || (aa=='3'))
	{
		//document.getElementById("aff").innerHTML=' 90 €';
		document.form1.amount.value='90';
	}
...
<span class="grey">Versailles (78)</span><br>
...
<div class="contbouton">
	<div class="preced"><a id="linkButton" href="tarifs-reservations.php">Retour page précedante</a></div>
