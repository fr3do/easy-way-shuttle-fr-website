...
<meta name="description" content="reservez d'une manière simple et pas cher pour vos déplacements vers Courchevel" />
<meta http-equiv="Content-Language" content="fr" />
<title>easy-way-shuttle | Navette privé à prix Low Cost de Paris vers Courchevel</title>
...
<script type="text/javascript">
 ...
 function aff_prix_b(aa) {
	   if(aa=='0')
	{
	 ...
	 if((aa=='1') || (aa=='2') || (aa=='3'))
	{
		//document.getElementById("aff").innerHTML=' 600 €';
		document.form1.amount.value='600';
	}
	...
	if((aa=='4') || (aa=='5') || (aa=='6'))
	{
		...
		if((aa=='7') || (aa=='8'))
	{
		//document.getElementById("aff").innerHTML=' 1100 €';
		document.form1.amount.value='1100';
	}
	...
	if((aa=='15') || (aa=='16'))
	{
		//document.getElementById("aff").innerHTML=' 1700 €';
		document.form1.amount.value='1700';
	}
...
<span class="grey">Courchevel (Savoie)</span><br>
