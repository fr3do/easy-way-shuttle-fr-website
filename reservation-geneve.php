...
<meta name="description" content="reservez d'une manière simple et pas cher pour vos déplacements vers Genève" />
<meta http-equiv="Content-Language" content="fr" />
<title>easy-way-shuttle | Navette privé à prix Low Cost de Paris vers Genève</title>
...
<script type="text/javascript">
 ...
 function aff_prix_b(aa) {
	   if(aa=='0')
	{
	 ...
	 if((aa=='1') || (aa=='2') || (aa=='3'))
	{
		//document.getElementById("aff").innerHTML=' 650 €';
		document.form1.amount.value='650';
	}
	...
	if((aa=='15') || (aa=='16'))
	{
		//document.getElementById("aff").innerHTML=' 1800 €';
		document.form1.amount.value='1800';
	}
...
<span class="grey">Genève</span><br>
