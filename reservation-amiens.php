...
<meta name="description" content="reservez d'une manière simple et pas cher pour vos déplacements vers Amiens" />
<meta http-equiv="Content-Language" content="fr" />
<title>easy-way-shuttle | Navette privé à prix Low Cost de Paris vers Amiens</title>
...
<script type="text/javascript">
 ...
 function aff_prix_b(aa) {
	   if(aa=='0')
	{
	 ...
	 if((aa=='1') || (aa=='2') || (aa=='3'))
	{
		//document.getElementById("aff").innerHTML=' 250 €';
	...
	if((aa=='4') || (aa=='5') || (aa=='6'))
	{
		...
		if((aa=='7') || (aa=='8'))
	{
		//document.getElementById("aff").innerHTML=' 480 €';
		document.form1.amount.value='480';
	}
	...
	if((aa=='15') || (aa=='16'))
	{
		//document.getElementById("aff").innerHTML=' 700 €';
		document.form1.amount.value='700';
	}
...
<span class="grey">Amiens (80)</span><br>
...
<select name="nb" id="nb" onChange="calc_simu();">
                 ...
                 <span class="grey">passager(s)</span><br><br>
