...
<meta name="description" content="reservez d'une manière simple et pas cher pour vos déplacements vers Lille" />
<meta http-equiv="Content-Language" content="fr" />
<title>easy-way-shuttle | Navette privé à prix Low Cost de Paris vers Lille</title>
...
<script type="text/javascript">
 ...
 function aff_prix_b(aa) {
	   if(aa=='0')
	{
	 ...
	 if((aa=='1') || (aa=='2') || (aa=='3'))
	{
		//document.getElementById("aff").innerHTML=' 300 €';
		document.form1.amount.value='300';
	}
	...
	if((aa=='4') || (aa=='5') || (aa=='6'))
	{
		...
		if((aa=='7') || (aa=='8'))
	{
		//document.getElementById("aff").innerHTML=' 550 €';
		document.form1.amount.value='550';
	}
	
		if((aa=='9') || (aa=='10') || (aa=='11'))
	{
		//document.getElementById("aff").innerHTML=' 400 €';
		document.form1.amount.value='550';
	}
	...
	if((aa=='15') || (aa=='16'))
	{
		//document.getElementById("aff").innerHTML=' 800 €';
		document.form1.amount.value='800';
	}
